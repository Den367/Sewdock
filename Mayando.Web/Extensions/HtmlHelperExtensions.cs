...
namespace Mayando.Web.Extensions
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        {
            return html.ActionLink(linkText, Enum.GetName(typeof(ActionName), actionName), controllerName, routeValues, htmlAttributes).ToHtmlString();
        }
        ...
        public static string DateTimeText(this HtmlHelper html, DateTimeOffset? time, DateTimeDisplayType type)
        {
            ...
            else
            {
                ...
                {
                    var link = html.ActionLinkPhotoDay(EmbroDateType.Taken, time.Value, text);
                ...
                {
                    var link = html.ActionLinkPhotoDay(EmbroDateType.Published, time.Value, text);
        ...
        public static string ActionLinkPhotoPrevious(this HtmlHelper html, EmbroNavigationContext context)
        {
            if (context.Previous != null)
            {
                var title = string.Format(CultureInfo.CurrentCulture, Resources.PhotoNavigateTo, context.Previous.DisplayTitle);
                return html.ActionLink(Resources.PhotoNavigatePrevious, ActionName.Details, new { id = context.Previous.Id, context = context.Type.ToActionString(), criteria = context.Criteria}, new { title = title });
            }
            else
            {
        ...
        public static string ActionLinkPhotoNext(this HtmlHelper html, EmbroNavigationContext context)
        {
            if (context.Next != null)
            {
                var title = string.Format(CultureInfo.CurrentCulture, Resources.PhotoNavigateTo, context.Next.DisplayTitle);
                return html.ActionLink(Resources.PhotoNavigateNext, ActionName.Details, new { id = context.Next.Id, context = context.Type.ToActionString(), criteria = context.Criteria }, new { title = title });
            }
            else
            {
        ...
        public static string ActionLinkPhoto(this HtmlHelper html, EmbroideryItem photo, NavigationContextType? navigationContextType, string navigationContextCriteria)
        {
        ...
        public static string ActionLinkPhotoYear(this HtmlHelper html, EmbroDateType type, DateTimeOffset year)
        {
            var linkText = year.Year.ToString(CultureInfo.CurrentCulture);
            var actionName = (type == EmbroDateType.Taken ? ActionName.Taken : ActionName.Published);
        ...
        /// <returns>An anchor tag for the photos.</returns>
        public static string ActionLinkPhotoMonth(this HtmlHelper html, EmbroDateType type, DateTimeOffset month)
        {
        ...
        /// <returns>An anchor tag for the photos.</returns>
        public static string ActionLinkPhotoDay(this HtmlHelper html, EmbroDateType type, DateTimeOffset day)
        {
        ...
        /// <param name="linkText">The inner text of the anchor tag.</param>
        /// <returns>An anchor tag for the photos.</returns>
        public static string ActionLinkPhotoDay(this HtmlHelper html, EmbroDateType type, DateTimeOffset day, string linkText)
        {
            var actionName = (type == EmbroDateType.Taken ? ActionName.Taken : ActionName.Published);
        ...
        public static string ActionLinkPhotoSize(this HtmlHelper html, EmbroSize size)
        {
            ...
            return html.RouteLink(linkText, new { size = sizeName }, new { title = title }).ToHtmlString();
        }
        ...
        /// <param name="linkText">The inner text of the anchor tag.</param>
        /// <returns>An anchor tag.</returns>
        public static string ActionLinkEmbroIndex(this HtmlHelper html, string linkText)
        {
            return html.ActionLink(linkText, ActionName.Index, EmbroController.ControllerName);
        }
        ...
        {
            return html.ActionLink(linkText, ActionName.Hidden, EmbroController.ControllerName);
        }
        ...
        {
            return html.ActionLink(linkText, ActionName.Create, EmbroController.ControllerName);
        }

        public static string ActionLinkPhotoUpload(this HtmlHelper html, string linkText)
        {
            return html.ActionLink(linkText, ActionName.Upload, EmbroController.ControllerName);
        }
        ...
        {
            return html.BeginForm(ActionName.Create, EmbroController.ControllerName);
        }
        ...
        {
            return html.BeginForm(ActionName.Edit, EmbroController.ControllerName);
        }
        ...
        {
            return html.BeginForm(ActionName.Search, EmbroController.ControllerName);
        }
        ...
        {
            return html.BeginForm(ActionName.BulkEdit, EmbroController.ControllerName, formId);
        }
        ...
        {
            return html.BeginForm(ActionName.BulkEditExecute, EmbroController.ControllerName);
        }
        ...
        {
            return html.BeginForm(ActionName.AddComment, EmbroController.ControllerName, null, submitButtonName);
        }
        ...
        public static string ActionLinkTag(this HtmlHelper html, string tag)
        {
            var title = string.Format(CultureInfo.CurrentCulture, Resources.TagNavigateTo, tag);
        ...
        {
            var title = string.Format(CultureInfo.CurrentCulture, Resources.TagNavigateTo, tagInfo.Tag);
        ...
        /// <returns>An anchor tag for the tag.</returns>
        private static string ActionLinkTag(this HtmlHelper html, string tag, string title)
        {
            return html.ActionLink(tag, ActionName.Latest, EmbroController.ControllerName, new { criteria = tag }, new { title = title });
        }
        ...
        {
            return html.ActionLink(linkText, actionInfo.Name.ToLowerInvariant(), actionInfo.Controller.Name.ToLowerInvariant()).ToHtmlString();
        }
        ...
        {
            return html.ActionLink(linkText, ActionName.Index, CommentController.ControllerName);
        }
        ...
        {
            return html.ActionLink(linkText, ActionName.Edit, CommentController.ControllerName, new { id = commentId, returnUrl = returnUrl }, new { @class = cssClass });
        }
        ...
        {
            return html.ActionLink(linkText, ActionName.Delete, CommentController.ControllerName, new { id = commentId, returnUrl = returnUrl }, new { @class = cssClass });
        }
        ...
        {
            return html.BeginForm(ActionName.AddComment, CommentController.ControllerName);
        }
        ...
        #region [Svg]       
        public static string ScaledSvg(this HtmlHelper helper, double verticalSizePx, EmbroideryItem embro)
        {

            return getSvgThumbnail(verticalSizePx, embro);
        
        
        }


        static string getSvgThumbnail(double size, EmbroideryItem embro)
        { 
         //var builder = new System.Web.Mvc.TagBuilder("span");
           // builder.MergeAttribute("name", embro.Title);
            XElement xSvg = XElement.Parse(embro.Svg);
            XElement xBoundsInfo = XElement.Parse(embro.Summary);
            EmbroideryBounds bounds = new EmbroideryBounds(xBoundsInfo);
         
            double h = (double)(bounds.Height);
            double w =(double)bounds.Width;
            double m = (h < w) ? w : h;
            ...
            double newW = w * k;
            double newH = h * k;
            double newMinX = bounds.Xmin * k;
            double newMinY = bounds.Ymin * k;
            double newMaxX = bounds.Xmax * k;
            double newMaxY = bounds.Ymax * k;
            //double translateX = - newMinX;
            //double translateY =  - newMinY;

            //double translateX = (newMaxX - newMinX) / 2;
            //double translateY = (newMaxY - newMinY) / 2;
            xSvg.Add(new XAttribute("name",embro.Title),new XAttribute("id",embro.Id),new XAttribute("class","thumbnail"));
            XAttribute width = xSvg.Attribute("width");
            XAttribute height = xSvg.Attribute("height");
            XAttribute viewBox = xSvg.Attribute("viewBox");
            XNamespace ns = "http://www.w3.org/2000/svg";
            XAttribute xTransform = xSvg.Element(ns + "g").Attribute("transform");
            SetXYScale(embro.FileExtension, k, ref  xScale, ref  yScale);
           
          
            xTransform.Value = string.Format(CultureInfo.InvariantCulture, "scale({0},{1})",  xScale, yScale);            
           
            width.Value = string.Format("{0}px", newW);
            height.Value = string.Format("{0}px", newH);
            viewBox.Value = string.Format("0 0 {0} {1}", newW, newH);
            return xSvg.ToString();
            //builder.InnerHtml = xSvg.ToString();
        ...
        public static MvcHtmlString SvgActionLink(this AjaxHelper helper, double verticalSizePx, EmbroideryItem embro, string actionName, object routeValues, AjaxOptions ajaxOptions)
        {
            var link = helper.ActionLink("[replaceme]", actionName, routeValues, ajaxOptions);

            //return link.ToString();
            return new MvcHtmlString(link.ToHtmlString().Replace("[replaceme]", getSvgThumbnail(verticalSizePx, embro)));
        }

        
        #endregion [Svg]
        public static string Textbox(this AjaxHelper ajaxHelper, string name, AjaxOptions ajaxOptions, object htmlAttributes)
        {
        ...
        #region [Qrcode]
        public static MvcForm BeginQrcodeForm(this HtmlHelper html, QrcodeFormViewModel model)
        {
            return html.BeginForm(ActionName.QrcodeForm, QrcodeController.ControllerName, null, FormMethod.Post, new { @class = "well" });
        }

       


            public static string Image<T>(this HtmlHelper helper, Expression<Action<T>> action, string text, int width, int height)
                where T : Controller
            {
                return Image<T>(helper, action, text, width, height, "");
            }
            ...
            public static string Image<T>(this HtmlHelper helper, Expression<Action<T>> action, string text, int width, int height, string alt)
               where T : Controller
            {
                ...
                string url = new UrlHelper(helper.ViewContext.RequestContext, helper.RouteCollection).Action(actionMethodName, typeof(T).Name.Remove(typeof(T).Name.IndexOf("Controller")), text);
        ...
        #endregion [Qrcode]
        #region [Aux]
        static void SetXYScale(string embroType,double scale, ref double xScale, ref double yScale)
        {
            switch (embroType.ToLower())
            {
                case "pes":
                case "pec":
                    yScale = scale;
