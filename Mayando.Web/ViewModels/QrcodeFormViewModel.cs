...
namespace Myembro.ViewModels
{
    public class QrcodeFormViewModel
    {
        ...
        [StringLength(24)]
        [Display(ResourceType = typeof(Myembro.Properties.Resources), Description = "LongitudeText")]
        [RegularExpression(@"^-?([1]?[1-7][1-9]|[1]?[1-8][0]|[1-9]?[0-9])\.{1}\d{1,6}", ErrorMessageResourceType = typeof(Myembro.Properties.Resources), ErrorMessageResourceName = "IncorrectNumberValue")]
        public string Longitude { get; set; }
      [StringLength(24)]
      [Display(ResourceType = typeof(Myembro.Properties.Resources), Description = "LatitudeText")]
        [RegularExpression(@"^-?([1-8]?[1-9]|[1-9]0)\.{1}\d{1,6}", ErrorMessageResourceType = typeof(Myembro.Properties.Resources), ErrorMessageResourceName = "IncorrectNumberValue")]
