    ...
    public class SettingsController : SiteControllerBase
    {
        ...
        public ActionResult Index()
        {
            using (var repository = GetRepository())
            {
                ...
                object settingsViewModel = null;// GetSettingsViewModel(settings, this.ControllerContext.HttpContext);
                return View(ViewName.Index, settingsViewModel);
            }
        }

        private object GetSettingsViewModel(object settings, HttpContextBase httpContextBase)
        {
        ...
        private object GetSettingsViewModel(object settings, HttpContextBase httpContextBase, bool p, UrlHelper urlHelper)
        {
            throw new NotImplementedException();
        }
        ...
        public static SettingsViewModel GetSettingsViewModel(IEnumerable<Setting> settings, HttpContextBase httpContext)
        {
            return GetSettingsViewModel(settings, httpContext, false, null);
        }

        public static SettingsViewModel GetSettingsViewModel(IEnumerable<Setting> settings, HttpContextBase httpContext, bool allowDelete, UrlHelper urlHelper)
        {
