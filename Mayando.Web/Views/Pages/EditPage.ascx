<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Myembro.Models.Page>" %>
        ...
        <fieldset>
            ...
            <p>
                <label for="PhotoId" class="optional">EmbroideryItem:</label>
                <%= Html.DropDownList("PhotoId", ViewData.GetPhotos()) %>
                <%= Html.CheckBox("HidePhotoText", Model.HidePhotoText)%>
                <label for="HidePhotoText" class="inline optional">Hide EmbroideryItem Text</label>
                <%= Html.CheckBox("HidePhotoComments", Model.HidePhotoComments)%>
                <label for="HidePhotoComments" class="inline optional">Hide EmbroideryItem Comments</label>
            </p>
            <p>
