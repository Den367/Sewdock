...
namespace Mayando.Web.Models
{
    ...
    public class ApplicationSettings
    {
        ...
        public string Keywords { get { return GetSetting(SettingNameKeywords); } set { SetSetting(SettingNameKeywords, value); } }
            ...
            return new SettingDefinition[]
                {
                    ...
                    new SettingDefinition(ApplicationSettings.SettingNameTitle, SettingType.Plaintext, "Title", "The title of your website.", sequence++, true, "My Photo Blog"),
                    ...
                    new SettingDefinition(ApplicationSettings.SettingNameLinkToExternalPhotoUrl, SettingType.Boolean, "Link Photo To External URL", "Determines if photos should link back to their external URL; by default they do (it's required for Flickr for example).", sequence++, true, bool.TrueString),
