...
namespace Mayando.Web.Controllers
{
    ...
    public class PagesController : SiteControllerBase
    {
        ...
        private ActionResult ViewForPage(Func<MayandoRepository, Page> pageSelector)
        {
            using (var repository = GetRepository())
            {
                ...
                PhotoDetailsViewModel photo = null;
                if (page.Photo != null)
                {
                    photo = this.GetPhotoDetailsViewModel(page.Photo, page.HidePhotoText, page.HidePhotoComments);
                }
