...
namespace Mayando.Web.Extensions
{
    ...
    public static class UrlHelperExtensions
    {
        ...
        /// <summary>
        /// Returns a virtual path for the specified photo.
        /// </summary>
        /// <param name="urlHelper">The URL helper.</param>
        /// <param name="photo">The photo to link to.</param>
        /// <returns>The virtual path to the photo.</returns>
        public static string PhotoDetails(this UrlHelper urlHelper, Photo photo)
        {
            return urlHelper.PhotoDetails(photo, null, null, null);
        }
        ...
        /// <param name="urlHelper">The URL helper.</param>
        /// <param name="photo">The photo to link to.</param>
        /// <param name="navigationContextType">The navigation context type.</param>
        /// <param name="navigationContextCriteria">The navigation context criteria.</param>
        /// <returns>The virtual path to the photo.</returns>
        public static string PhotoDetails(this UrlHelper urlHelper, Photo photo, NavigationContextType? navigationContextType, string navigationContextCriteria)
        {
            return urlHelper.PhotoDetails(photo, navigationContextType, navigationContextCriteria, null);
        }
        ...
        /// <returns>The virtual path to the photo.</returns>
        public static string PhotoDetails(this UrlHelper urlHelper, Photo photo, NavigationContextType? navigationContextType, string navigationContextCriteria, int? slideshowDelay)
        {
            return urlHelper.Action(ActionName.Details, PhotosController.ControllerName, new { id = photo.Id, context = navigationContextType.ToActionString(), criteria = navigationContextCriteria, slideshow = slideshowDelay });
        }
        ...
        {
            var photoUrl = urlHelper.PhotoDetails(comment.Photo);
